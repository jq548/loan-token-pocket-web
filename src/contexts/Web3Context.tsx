...
const LOAN_CONTRACT = process.env.LOAN_CONTRACT;
...
export const Web3Provider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <Web3Context.Provider value={{ web3, account, usdtContract, lpContract, loanContract, connectWallet, disconnectWallet }}>
      {children}
